# {PROJECT_NAME} - Claude Code 프로젝트 가이드
...
- **프로젝트명**: {PROJECT_NAME}
- **설명**: {한 줄 설명}
- **기술 스택**: Backend {스택} / Frontend {스택}

## 주요 규칙
1. **에이전트**: @agents/AGENTS_RULE.md
2. **보안**: @rules/SECURITY.md
3. **빌드/실행**: @rules/COMMANDS.md
4. **테스트**: @rules/TESTING.md
5. **Git**: 사용자 직접 호출만 가능 (`[git]` 접두사 필수)
